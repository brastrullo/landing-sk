<script>
  import { darkMode, toggleState } from '../utils/store.js';
...
<div class="flex items-center mr-2">
  <label class="relative inline-block w-8 h-4">
    ...
    <span class="rounded-full absolute cursor-pointer top-0 left-0 right-0 bottom-0 bg-white border border-black transition"></span>
